...
## Tips
A few notes...
* If you'd like to see a good example of my **TypeScript** skills please see the [Firestore Manager project](https://github.com/AliEskandari/firestore-manager/src/functions). There you will see a heavy use of TypeScript Generics, Type Inference, and Function Declaration Overloading.
...
* For a good example of my **modular approach to large projects**, see the the **Lockr** project repo - specifically for the folder structure and `modules` folder.
